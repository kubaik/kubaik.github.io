...
They ship AI-generated code and assume the manager will *just know* it’s better. In one case, an engineer in Accra added a copilot-generated cache layer that cut API latency from 380ms to 110ms. He asked for a raise based on “speed,” but the manager pushed back because the latency drop didn’t translate to revenue. When he added conversion data—*“380ms to 110ms lifted checkout completion by 2.1% on mobile 3G in Kenya”*—the raise sailed through.
