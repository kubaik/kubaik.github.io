...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch('{{ base_path }}/posts.json')
            .then(r => r.json())
            .then(posts => { allPosts = posts; updateLoadMoreButton(); })
        ...
        function updateLoadMoreButton() {
            ...
            loadMoreButton.style.display = (hasMorePosts() && !infiniteScrollEnabled) ? 'block' : 'none';
        }
...
<body>
    ...
    <main class="container">
        ...
        <article class="page-content">
            ...
            <div class="contact-method">
                <h3>📝 Guest Posting</h3>
                <p>We welcome high-quality guest posts on AI, Machine Learning, NLP, Computer Vision, AI Ethics, and emerging technologies. Include "Guest Post Submission" in your subject line.</p>
            </div>
            <div class="contact-method">
                <h3>⏰ Office Hours</h3>
