            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function highlightMatch(card, query) {
                    ...
                    if (excerpt) {
                        ...
                        const highlightedExcerpt = highlightText(excerptText, query);
                        excerpt.innerHTML = highlightedExcerpt;
                    }
                }
                ...
                function updateResultsCount(count, query) {
                    if (count === 0) {
                        ...
                        searchResultsCount.textContent = `1 post found`;
                    } else {
                        searchResultsCount.textContent = `${count} posts found`;
                    }
                }
                ...
                function showNoResults() {
                    ...
                    postsContainer.insertAdjacentHTML('afterend', noResultsHTML);
                }
