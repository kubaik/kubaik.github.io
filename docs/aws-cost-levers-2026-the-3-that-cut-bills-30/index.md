...
This post is what I wish I’d had then: a clear ranking of the AWS cost levers that actually move the needle, with real-world benchmarks and pitfalls.
...
1. Is your workload predictable week-to-week? - Yes → Savings Plans
   - No → Compute Optimizer

2. Do you have DevOps capacity for monthly reviews? - Yes → Compute Optimizer + CAD
   - No → Savings Plans

3. Is your bill >$10k/month and growing? - Yes → Both (Savings Plans for baseline, Compute Optimizer for refactors)
   - No → Savings Plans only

4. Are you planning a major refactor or migration in the next 6 months? - Yes → Compute Optimizer
   - No → Savings Plans
